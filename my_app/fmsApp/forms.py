...
class UserRegistration(UserCreationForm):
    ...
    #0429##3
    # Group = [('1', '1'), ('2', '2'), ('3', '3'), ]
    groups = forms.CharField(max_length=250,help_text="The group field is required.")
    ...
    class Meta:
        ...
        #0429
        fields = ('email', 'username', 'password1', 'password2', 'first_name', 'last_name', 'groups')
    def clean_group(self):
        group_name = self.cleaned_data['groups']
        #print(group_name)
        logger.debug(group_name)
        user = User.objects.get(groups=group_name)
    # ##############
